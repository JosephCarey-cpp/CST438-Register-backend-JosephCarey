...
public class GradebookServiceREST extends GradebookService {
	...
	public void enrollStudent(String student_email, String student_name, int course_id) {
		...
		EnrollmentDTO responce = restTemplate.postForObject(gradebook_url+"/enrollment",enrollment,EnrollmentDTO.class);
		System.out.println("Responce from gradebook " + responce);
	}
